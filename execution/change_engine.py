...
from core.types import FileChange, ChangeSet, ChangeType, ValidationResult
...
class ChangeEngine:
    ...
    async def stage_changes(self, changes: list[FileChange], description: str) -> ChangeSet:
