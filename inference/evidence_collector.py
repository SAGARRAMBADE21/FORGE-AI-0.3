...
from core.types import (
    Evidence, EvidenceSource, DataModel, APICall, FormInfo,
    FieldInfo, AuthPattern
)
...
class EvidenceCollector:
    ...
    def _add_api_evidence(self, api: APICall, evidence_map: dict):
        ...
        evidence_map[model_name].append(Evidence(
    ...
    def _parse_zod_fields(self, schema_body: str) -> list[dict]:
        ...
        for match in re.finditer(r'(\w+)\s*:\s*z\.(\w+)\(\)', schema_body):
            ...
            fields.append({
                ...
                "required": '.optional()' not in schema_body[match.end():match.end()+20],
            })
