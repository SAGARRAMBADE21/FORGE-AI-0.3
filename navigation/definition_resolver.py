...
from core.types import (
    Symbol, SymbolKind, NavRequest, DefinitionResult, 
    LocationLink, Range, Position
)
...
class DefinitionResolver:
    ...
    async def get_definition(self, request: NavRequest) -> DefinitionResult:
        ...
        return DefinitionResult(
            symbol=definitions[0] if definitions else None,
            definitions=definitions
        )

    def _get_identifier_at_position(self, content: str, position: Position) -> str | None:
