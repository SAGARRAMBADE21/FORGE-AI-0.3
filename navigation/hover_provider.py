...
from core.types import Symbol, SymbolKind, NavRequest, HoverInfo, Position
...
class HoverProvider:
    ...
    def _build_hover_content(self, symbol: Symbol) -> str:
        ...
        if type_annotation and symbol.kind in (SymbolKind.VARIABLE, SymbolKind.CONSTANT, SymbolKind.PROPERTY):
