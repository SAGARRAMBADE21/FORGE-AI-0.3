...
class LanguageRegistry:
    ...
    def _register_languages(self):
        ...
        try:
            ...
            self._register(Language.PYTHON, LanguageConfig(
                name="python",
        ...
        try:
            ...
            self._register(Language.JAVASCRIPT, LanguageConfig(
                name="javascript",
                ts_language=js_lang,
            ...
            self._register(Language.JSX, LanguageConfig(
                name="jsx",
                ts_language=js_lang,
                extensions=[".jsx"],
            ))
        ...
        try:
            ...
            self._register(Language.TYPESCRIPT, LanguageConfig(
                name="typescript",
                ts_language=ts_lang,
                extensions=[".ts", ".mts"],
            ))
            self._register(Language.TSX, LanguageConfig(
                name="tsx",
        ...
        try:
            ...
            self._register(Language.GO, LanguageConfig(
                name="go",
        ...
        try:
            ...
            self._register(Language.RUST, LanguageConfig(
                name="rust",
        ...
        try:
            ...
            self._register(Language.JAVA, LanguageConfig(
                name="java",
        ...
        try:
            ...
            self._register(Language.C, LanguageConfig(
                name="c",
        ...
        try:
            ...
            self._register(Language.CPP, LanguageConfig(
                name="cpp",
        ...
        try:
            ...
            self._register(Language.CSHARP, LanguageConfig(
                name="csharp",
        ...
        try:
            ...
            self._register(Language.RUBY, LanguageConfig(
                name="ruby",
        ...
        try:
            ...
            self._register(Language.PHP, LanguageConfig(
                name="php",
